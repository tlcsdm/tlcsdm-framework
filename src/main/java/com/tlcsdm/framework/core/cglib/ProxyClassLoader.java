...
import com.tlcsdm.framework.core.cglib.asm.AsmProxyClassWriter;
import com.tlcsdm.framework.core.cglib.asm.AsmUtil;
...
public final class ProxyClassLoader extends ClassLoader {
    ...
    Class getProxyClass(Class superclass, boolean isWriteFile) {
        String cacheKey = ProxyClass.getProxyClassName(superclass);
